...
* <b> COMING SOON</b>  A new version 4 of the Exclusions API is coming soon:
...
| fascsaOrder | Allows Yes and No.<br><br> This parameter accepts either value, in any case.<br><br> Example: fascsaOrder=Yes, fascsaOrder=yes, fascsaOrder=No, fascsaOrder=no | v4 |
